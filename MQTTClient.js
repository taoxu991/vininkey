...
var defaultPubTopic = "light";
var defaultPubMessage = "{\"led\":\"red\",\"value\": 1}";
...
var client = null;
var clientId_temp = "Client" + Math.floor(10000 + Math.random() * 90000);
$("#connectClientID").val("Client" + Math.floor(10000 + Math.random() * 90000));

$("#connectButton").click(function(event) {
	var server = "139.199.213.78";
	var port = 9010;
	var clientId = clientId_temp;
	var username = "xutao";
...
$("#opendoorButton").click(function(event) {
	var topic = "vinin/door";
	var message = "{\"vinin\":\"door\",\"value\": 1}";
	var qos = 0;
	retained = false;
	publish(topic, message, qos, retained);
});
